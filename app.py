...
safe_image("chonguk.png", width=180)

# 3. Список вопросов
questions = [
    {"q": "В каком городе России впервые отметили международный женский день?",
     "o": ["Москва", "Санкт-Петербург", "Самара"],
     "a": "Санкт-Петербург",
     "h_img": "spb.png"},

    {"q": "Как называется предмет, изображенный на картинке?",
     "q_img":"akhn1.jpg",
     "o": ["Катастрофическая камера", "Активная камера", "Экшн-камера"],
     "a": "Экшн-камера",},

    {"q": "С чем окружающие ассоциируют твой смех?",
     "o": ["Мойка окон", "Кашель тюленя", "Старые Жигули"],
     "a": "Мойка окон",
     "h_img": "okno.jpg"},

    {"q": "Какую букву ты пишешь СВОЕОБРАЗНО?",
     "o": ["«А»", "«Д»", "«Ж»"],
     "a": "«Ж»",
     "h_text": "Пиджак..."},

    {"q": "Кто автор песни «Рюмки водки на столе»?",
     "o": ["Лепс", "Лесп", "Uma2rman"],
     "a": "Лепс",
     "h_img": "ro.jpg"},

    {"q": "Как зовут нашего (или воображаемого) кота?",
     "o": ["Барсик", "Мурзик", "Леопольд"],
     "a": "Барсик"},

    {"q": "Какая песня у нас ассоциируется с отпуском?",
     "o": ["Песня А", "Песня Б", "Песня В"],
     "a": "Песня Б"}
]
